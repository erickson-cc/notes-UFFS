...
def analisadorLex(entrada, afd, finais_afd, rotulos_afd):
    ...
    while i<tamanho: # percorre conteúdo inteiro
        ...
        if estado_corrente == "_": # Tratamento de ERRO rótulo
            rotulo_final = "erro"
            fita.append("_") # envia o erro para o sińtático
            if indice_erro != -1:
            ...
            if "variavel" in rotulo_temp:   # variavel
                ...
                fita.append("variavel") #envia a string variável para o sintático
            else:                           # palavra reservada
                rotulo_final = rotulo_temp
                fita.append(palavra_lida) # envia a palavra lida para o sintático
...
def executar_lexico():
    try:
        ...
        fita, tabela = analisadorLex(entrada, afd, finais_afd, rotulos_afd)
        return fita, tabela
