...
def analisadorLex(entrada, afd, finais_afd, rotulos_afd):
    ...
    while i<tamanho:
        ...
        inicio_token = i
        indice_erro = -1 # Rastrear onde o erro começa
        ...
        if estado_corrente == "_":
            rotulo_final = "erro"
            if indice_erro != -1:
                # teve erro no meio da palavra
                parte_verde = conteudo[inicio_token:indice_erro]
                parte_vermelha = conteudo[indice_erro:i]
                palavra_formatada = f"{verde}{parte_verde}{vermelho}{parte_vermelha}{reset_cor}"
            else:
                # teve erro no estado final
                palavra_formatada = f"{vermelho}{palavra_lida}{reset_cor}"
        else:
            ...
            palavra_formatada = palavra_lida
