# -*- coding: utf-8 -*-
# Gerar um AFD livre de estados inalcanÃ§Ã¡veis e mortos
# Entrada: Arquivo com a relaÃ§Ã£o de tokens e/ou GRs de uma linguagem
# SaÃ­da: AFD e mÃ­nimo sem a aplicaÃ§Ã£o de classes de equivalÃªncia entre estados.
# Autor: Erickson Giesel MÃ¼ller
# MatrÃ­cula: 20230001178

#------------vvvvvvvvv  VARIÃVEIS GLOBAIS  vvvvvvvvv------------
afnd = {}
estados_finais = set()      # conjunto para guardar estados finais
contador_estados = -1        # VariÃ¡vel para gerar nomes de estados (A-B-C-D-E...)
mapa_gramatica = {"S":"S"}
rotulos_originais = {}
arquivo = "fonte.txt"
entrada = "entrada.txt"

#------------vvvvvvvvv CRIAÃÃO DO AUTÃMATO vvvvvvvvv------------
def processarGramatica(linha):
    ...
    lados = linha.split("::=") #[,] esquerdo = <S> ; direito = a<A> | b<A> | Îµ
    ...
    for p in producoes:
        ...
        if p == "Îµ": # Caso seja produÃ§Ã£o vazia
...
def determinizar(afnd, estados_finais):
    ...
    rotulos_afd = {} # relatÃrio, os estados se fundem labelOriginal -> labelComposto
    ...
    while fila:
        ...
        for i in conjunto_atual:
            ...
            if i in estados_finais:
                ...
                if i in rotulos_originais: # lÃgica das labels do afd
